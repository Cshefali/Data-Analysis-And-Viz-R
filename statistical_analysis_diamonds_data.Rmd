...
#### **Annotate histogram with mean/median line** 
...
df1_unique %>% 
  ...
  geom_histogram(binwidth = 0.3,
                 ...
                 closed = "left")+
  #mean line
  geom_vline(xintercept = mean(df1_unique$carat), color = "blue", linetype = "dashed")+
  #label mean
  annotate(geom = "text", label = "mean", color = "blue",
           fontface = "bold", size = 1.5, angle = 90)
  scale_x_continuous(breaks = seq(0,5.3,.3),
                     labels = seq(0,5.3,.3))+
  scale_y_continuous(expand = expansion(mult = c(0,0.02)))+
